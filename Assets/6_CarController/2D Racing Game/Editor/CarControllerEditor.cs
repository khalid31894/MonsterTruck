...
public class CarControllerEditor : Editor{
	...
	public override void OnInspectorGUI ()
	{
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("forward"),
                new GUIContent("Forward Move", "Forward Move Check"), true);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("backward"),
                new GUIContent("backward Move", "backward Move Check"), true);
		
		EditorGUILayout.PropertyField(serializedObject.FindProperty("JumpPower"),
                new GUIContent("JumpPower", "jump power"), true);
		...
		EditorGUILayout.PropertyField (serializedObject.FindProperty ("finishGateReached"),
			new GUIContent ("finishGateReached", "finishGate"), true);
		EditorGUILayout.Space ();
		
		EditorGUILayout.PropertyField (serializedObject.FindProperty ("TargetAchieved"),
			new GUIContent ("TargetAchieved", "TargetAchieved"), true);
		EditorGUILayout.Space ();
		
		EditorGUILayout.PropertyField (serializedObject.FindProperty ("Stopcar"),
			new GUIContent ("when hit the stop car trigger car velocity will be zero", "Stopcar"), true);
		EditorGUILayout.Space ();
		
		EditorGUILayout.PropertyField (serializedObject.FindProperty ("IsGamePlay"),
			new GUIContent ("IsGamePlay", "IsGamePlay"), true);
		EditorGUILayout.Space ();
