...
namespace IndieStudio.DrawingAndColoring.Logic
{
    ...
    public class Tool : MonoBehaviour
    {
        ...
        public void EnableSelection()
        {
            ...
            {
                transform.DOLocalRotate(new Vector3(0, 0, 20), 0.01f).SetEase(Ease.Linear);
            }
            else
            {
                transform.DOLocalRotate(new Vector3(0, 0, 20), 0.3f).SetEase(Ease.Linear);
            }
        }
        ...
        public void DisableSelection()
        {
            ...
            for (int i = 0; i < gameManager.tools.Length; i++)
            {
                gameManager.tools[i].transform.DOLocalRotate(Vector3.zero, 0f);
            }
        }
